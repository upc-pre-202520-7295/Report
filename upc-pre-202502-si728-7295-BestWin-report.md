...
|---------------------|---------------------|--------------|
| Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerarquicos, en el marco del desarrollo de un proyecto en ingeniería. | **Bernaola Pérez, André Arturo**<br>*TB1*<br>  Durante el proyecto comuniqué de forma oral mis ideas y resultados al equipo, presentando los diagramas de arquitectura y explicando los hallazgos de las entrevistas. Esto permitió que todos comprendieran las decisiones técnicas y de análisis, facilitando la coordinación y el trabajo en conjunto.  <br><br>*TP*<br> Aseguré la coordinación entre el diseño de software y la implementación al documentar los diagramas de arquitectura de componentes y de código, facilitando la comunicación técnica con el equipo de desarrollo. <br><br>*TB2*<br> Para esta entrega establecí los sistemas de búsqueda y navegación como parte de la solución Móvil. La navegación es intuitiva entre el Dashboard y Value Bets, y la vista Filters and Search. Permitiendo la gestión visual de equipos y partidos.  <br><br> **Loli Ruiz, Renzo Javier**<br>*TB1*<br> En esta fase del proyecto comuniqué de forma oral las decisiones de diseño basadas en el proceso de DDD a todo el equipo detallando los contextos delimitados y los Lenguajes Ubicuos para modelar el dominio del negocio.  <br><br>*TP*<br>   Para esta entrega establecí los sistemas de búsqueda, etiquetado y navegación como parte de la Arquitectura de Información de la solución. <br><br>*TB2*<br> Desarrollo de funcionalidades definidas para el Sprint 1 de la implementación de Betalyze. Se estableció la integración y obtención de datos de APIs externas para proveer información. Paralelamente, se desarrollaron los servicios esenciales basados en Spring Boot para gestión de equipos favoritos y la administración de notificaciones.<br>*TB3*<br> Presenté al equipo los avances del backend y las mejoras continuas realizadas, explicando cómo impactan en la funcionalidad del proyecto y facilitando la coordinación con los demás miembros.  <br><br> **Soriano Medrano, Diego**<br>*TB1*<br>  En esta primera fase del proyecto comuniqué en reuniones del equipo temas relacionados a los escenarios de atributos de calidad, permitiendo que el equipo pueda plantear el diseño arquitectónico. <br><br>*TP*<br> Para esta entrega se coordinó los wireframes y mock-ups tanto para la Landing Page como para las pantallas principales de las Aplicaciones.  <br><br>*TB2*<br> Establecí los sistemas de búsqueda y navegación como parte de la solución Web. Esto se logró con el desarrollo de cards informativas y etiquetas en vistas como Dashboard y Value Bets, optimizando la forma en que los usuarios acceden y procesan la información de los partidos.  <br><br> | <br><br>*TB1*<br> En el desarrollo de estos primeros capítulos, la comunicación oral fue fundamental para alinear al equipo y realizar el proceso de Domain-Driven Design (DDD) y detallar los escenarios de calidad clave. Explicar conceptos complejos como los Contextos Delimitados, el proceso de ADD y la elaboración de la arquitectura de nuestra solución aseguró que todos comprendieran y apoyaran el planteamiento de la solución, facilitando así una ejecución más fluida del proyecto.  <br><br>*TP*<br> La comunicación oral fue esencial para alinear al equipo y asegurar el avance del proyecto. Se presentaron y explicaron de forma clara los diagramas de arquitectura, el enfoque DDD y las decisiones de diseño UX/UI, logrando que todo el equipo entendiera y validara la estructura y el progreso de la solución.  <br><br>*TB2*<br> Se establece que, durante el primer sprint del proyecto Betalyze, el equipo de desarrollo alcanzó la implementación de los productos mínimos viables para las plataformas Web y Móvil, cubriendo las funcionalidades esenciales como Dashboard, Value Bets, Filters and Search, Metrics and History, y Favorites. Además, de realizar el desarrollo de los Servicios Web, logrando la integración con APIs externas para la obtención de datos, asegurando así la obtención de información para ambas aplicaciones.  <br><br> |
| Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerarquicos, en el marco del desarrollo de un proyecto en ingeniería. | **Bernaola Pérez, André Arturo**<br>*TB1*<br> Aporté en la comunicación escrita mediante la redacción de los primeros capítulos del informe, donde incluí el análisis del problema y el registro de entrevistas, además de documentar los diagramas de arquitectura. Con ello aseguré que la información se presentara de manera clara y objetiva para distintos públicos. <br><br>*TP*<br>  Para esta entrega aporté con la definición de las Guías de Estilo visuales y para dispositivos para la futura aplicación web y móvil.  <br><br>*TB2*<br> Para esta entrega aporte con la descripción de los sistemas de búsqueda y navegación. La usabilidad fue validada mediante entrevistas, confirmando que la información soporta efectivamente el acceso a los datos de predicción en dispositivos móviles.  <br><br> **Loli Ruiz, Renzo Javier**<br>*TB1*<br> Aporté a la comunicación escrita en el proyecto redacción de los contextos delimitados y sus mapas de contexto, aporté con el equipo describiendo las entidades, agregados y servicios de cada módulo clave para el negocio.   <br><br>*TP*<br> Presenté oralmente los diagramas de arquitectura de software y las decisiones técnicas basadas en Domain-Driven Design (DDD) para alinear la estrategia de desarrollo con el equipo.  <br><br>*TB2*<br> Aporte la descripción de la implementación de los servicios para la entrega de datos de partidos, la gestión de favoritos y las notificaciones, sentando la base de datos necesaria para el funcionamiento coherente de las aplicaciones frontend.<br>*TB3Documenté los cambios y mejoras del backend, mostrando de manera clara los avances y asegurando que el equipo comprendiera las actualizaciones y su funcionamiento.*<br>   <br><br> **Soriano Medrano, Diego**<br>*TB1*<br> Aporté en la documentación de los escenarios de calidad, redacté información relacionada y los cuadros necesarios para el análisis de atributos de calidad, aportando a las decisiones arquitectónicas. <br><br>*TP*<br>  Facilité la comprensión de conceptos complejos como los Contextos Delimitados y los escenarios de atributos de calidad mediante presentaciones orales, asegurando el apoyo del equipo al planteamiento arquitectónico.    <br><br>*TB2*<br> Como resultado se describió la implementación de las páginas de la aplicación Web. El desarrollo cubrió la funcionalidad de visualización y filtrado de partidos, con una evaluación que garantiza una interfaz web clara y funcional.  <br><br> | <br><br>*TB1*<br>  A través de una comunicación escrita clara y objetiva, se aseguró que el equipo comprenda la información más importante y crítica del nuestra solución. La documentación detallada de los escenarios de calidad y los mapas de contexto de DDD sirvieron como una referencia, garantizando que las desiciones arquitectónicas estuvieran alineadas con los objetivos de nuestra solución.   <br><br>*TP*<br> La documentación escrita del informe técnico fue clave para comunicar con objetividad los resultados del proyecto. Al formalizar el Diseño Táctico y las Guías de Estilo y Arquitectura, se estableció una referencia única y clara que alineó al equipo, asegurando la consistencia y la toma de decisiones informada.   <br><br>*TB2*<br> El Sprint 1 de Betalyze aseguró la integración de datos externos y la exposición de información de partidos, favoritos y notificaciones. Paralelamente, se entregaron las funcionalidades centrales en la Aplicación Web y la Aplicación Móvil. Los productos fueron validados mediante entrevistas, confirmando la usabilidad y la entrega de información para el acceso efectivo a las predicciones y datos de partidos de fútbol.  <br><br> |
...
Somos una startup tecnológica enfocada en el mundo de las apuestas deportivas de fútbol, que busca transformar la manera en que los usuarios toman decisiones al apostar. Desarrollamos una aplicación que ofrece probabilidades claras, precisas y fáciles de entender, generadas a partir de datos estadísticos y algoritmos y machine learning, para que cada usuario pueda evaluar mejor sus opciones antes de apostar.<br>
...
En el mercado de apuestas deportivas en Perú, muchos fanáticos del fútbol toman decisiones basadas principalmente en la intuición o en datos fragmentados obtenidos de redes sociales, grupos informales o páginas poco especializadas. Esto genera un alto nivel de incertidumbre y deja a los usuarios expuestos a predicciones poco confiables que no responden de manera real a las dinámicas del deporte.<br>
...
![LeanUXCanvas](./assets/LeanUXCanvas.jpg)
...
<div align="center">
  <img src="https://m.forebet.com/images/previews/16497.jpg"></img>
</div>
...
<div align="center">
  <img src="https://play-lh.googleusercontent.com/_6toGujckLEOu06ehpj_fpiy3JJJIndA25Nfh0s-w7ZgII_vS6uTb0wYyQSeE24YTNk=w526-h296-rw"></img>
</div>
...
<div align="center">
  <img src="https://www.baste-sportive.com/wp-content/uploads/2024/01/Screenshot-2024-01-18-140634.png"></img>
</div>
...
<table>
    <thead>
        ...
        <tr>
            ...
            <th> <div align="center"> Betalyze <br> <!--<img src="" width="120" height="120"></img>--> </div> </th>
            <th> <div align="center"> Forebet <br> <img src="https://play-lh.googleusercontent.com/gEAkphE_7E-wq4wHEJVT_GkAb7fLuR6y1dFudRCTDxAr6QST4Y4Il8rJ2sudzFDgpp4" width="120" height="120"></img> </div> </th>
            <th> <div align="center"> Betmines <br> <img src="https://play-lh.googleusercontent.com/za8ibEQwx2oCh5aMbHjhhVTyWXrEMWEm7DxI_7tq3vBTA2mvChBAi_cQ_FWM3sfGQXTp" width="120" height="120"></img> </div> </th>
            <th> <div align="center"> PredictZ <br> <img src="https://pbs.twimg.com/profile_images/1213432526267670528/2h6geqP8_200x200.jpg" width="120" height="120"></img> </div> </th>
        </tr>
    </thead>
    <tbody>
        <tr>
...
<table>
  <thead>
        <tr>
            <th>  </th>
            <th> <div align="center"> Estrategias </div> </th>
            <th> <div align="center"> Tácticas </div> </th>
        </tr>
    </thead>
    <tbody>
        <tr>
...
| Edad                 | N/A  |
| Distrito             | N/A  |
| Screenshot           | ![](./assets/entrevista-1.png) |
...
| Edad                 | 20  |
| Distrito             | Callao  |
| Screenshot           | ![](./assets/entrevista-2.png) |
...
| Screenshot           | ![](./assets/entrevista-3.png) |
...
| Screenshot           | ![](./assets/entrevista-4.png) |
...
| Edad                 | N/A  |
| Distrito             | Lima  |
| Screenshot           | ![](./assets/entrevista-5.png) |
...
| Screenshot           | ![](./assets/entrevista-6.png) |
...
Para el primer Sprint de Betalyze se desarrolló la base de los productos que comprende nuestra solución utilizando Flutter con Dart para la Aplicación Móvil, Angular para la Aplicación Web, y Spring Boot para los Servicios Backend. Las funcionalidades implementadas en ambas aplicaciones incluyen las páginas Dashboard, Value Bets, Filters and Search, Metrics and History, Favorites y Match Details. En el Backend, se lograron la integración y obtención de datos de APIs de terceros, y el desarrollo de servicios para proveer datos de partidos, favoritos y notificaciones.
...
| https://github.com/upc-pre-202520-7295/Landing-Page | develop | ba85783 | feat: hero-section | - | 12/11/2025 |
| https://github.com/upc-pre-202520-7295/Landing-Page | develop | 9587831 | feat: images and styles | - | 12/11/2025 |
| https://github.com/upc-pre-202520-7295/Landing-Page | develop | d001bbe | feat: add screenshots and CTA sections to index.html | - | 13/11/2025 |
| https://github.com/upc-pre-202520-7295/Landing-Page | develop | cddf4b5 | feat: added benefits, about the product and how it works sections | - | 14/11/2025 |
| https://github.com/upc-pre-202520-7295/Landing-Page | develop | 26ba55c | feat: add script for landing page | - | 14/11/2025 |
...
| https://github.com/upc-pre-202520-7295/Web-Application | develop | a1b322b | feat: add header | - | 12/11/2025 |
| https://github.com/upc-pre-202520-7295/Web-Application | develop | 5637599 | feat: add sidenav | - | 12/11/2025 |
| https://github.com/upc-pre-202520-7295/Web-Application | develop | 5afd3c4 | Merge branch 'layout' into develop | - | 12/11/2025 |
| https://github.com/upc-pre-202520-7295/Web-Application | develop | ae0f308 | feat: add and configure Page not found | - | 12/11/2025 |
| https://github.com/upc-pre-202520-7295/Web-Application | develop | dfe4e6a | feat: add user management page | - | 12/11/2025 |
| https://github.com/upc-pre-202520-7295/Web-Application | develop | 3f0c1bd | feat: add favorite user teams page | - | 12/11/2025 |
| https://github.com/upc-pre-202520-7295/Web-Application | develop | ec89196 | feat: add notifications bounded context | - | 13/11/2025 |
| https://github.com/upc-pre-202520-7295/Web-Application | develop | 1247f06 | feat: add betting insights bounded context | - | 13/11/2025 |
| https://github.com/upc-pre-202520-7295/Web-Application | develop | 2c1bed0 | feat: added data retrieval bounded context | - | 13/11/2025 |
| https://github.com/upc-pre-202520-7295/Web-Application | develop | faadebb | feat: added data retrieval bounded | - | 13/11/2025 |
| https://github.com/upc-pre-202520-7295/Web-Application | develop | 773b4db | feat: added predition and analytics bounded | - | 12/11/2025 |
...
| https://github.com/upc-pre-202520-7295/Mobile-Application | develop | 93db86e | feat: add notifications bc | - | 13/11/2025 |
| https://github.com/upc-pre-202520-7295/Mobile-Application | develop | 9fec5cf | feat: add shared files | - | 13/11/2025 |
| https://github.com/upc-pre-202520-7295/Mobile-Application | develop | 04408e4 | feat: implement Firebase messaging setup and token retrieval | - | 13/11/2025 |
| https://github.com/upc-pre-202520-7295/Mobile-Application | develop | 4dff076 | feat: add team model and entity for favorites bc | - | 13/11/2025 |
| https://github.com/upc-pre-202520-7295/Mobile-Application | develop | 18c211e | feat: add user entity and model with JSON serialization for IAM bc | - | 13/11/2025 |
| https://github.com/upc-pre-202520-7295/Mobile-Application | develop | f5d6cb5 | feat: add betting insights | - | 13/11/2025 |
| https://github.com/upc-pre-202520-7295/Mobile-Application | develop | 6816ab3 | feat: added data retrieval bounded | - | 13/11/2025 |
...
| https://github.com/upc-pre-202520-7295/Backend | develop | 189048f | feat: add favorites | - | 13/11/2025 |
| https://github.com/upc-pre-202520-7295/Backend | develop | 8e13385 | feat: add notifications | - | 13/11/2025 |
...
- Durante el Sprint 1 de la implementación de Betalyze se estableció una base de los productos de nuestra solución, utilizando Angular para la Web, Flutter con Dart para la App Móvil, y Spring Boot para el Backend. Se desarrollaron las funcionalidades centrales para ambas plataformas como Dashboard, Value Bets, Filtros y Búsqueda, Métricas e Historial, Favoritos y Detalles de Partido. Por el lado de desarrollo de Servicios Web se logró la integración con APIs de terceros para obtener datos, y se desarrolló servicios para proveer los datos de partidos, favoritos y notificaciones. Finalmente, la validación de los productos Web y Móvil se realizó mediante entrevistas y evaluación según heurísticas.
