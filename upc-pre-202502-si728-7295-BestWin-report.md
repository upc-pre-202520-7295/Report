...
| **EP05** | Personalización y Experiencia  | Funcionalidades que permiten personalizar el dashboard, elegir ligas/equipos favoritos y mejorar la experiencia visual (modo oscuro).  |  |  |
...
| US12                     | Configurar ligas preferidas      | Como usuario quiero elegir mis ligas preferidas para personalizar mi dashboard.                                                                | Scenario 1: Configuración aplicada – Dado que selecciono ligas, cuando guardo, entonces se filtra mi inicio.<br><br>Scenario 2: Error de sincronización – Dado que no se guardó, cuando recargo, entonces vuelvo a ver todas las ligas. | EP05 |
| US13                     | Activar modo oscuro              | Como usuario quiero habilitar modo oscuro para tener experiencia más cómoda.                                                                   | Scenario 1: Cambio exitoso – Dado que activo el switch, cuando confirmo, entonces la interfaz cambia a modo oscuro.<br><br>Scenario 2: No soportado – Dado que mi navegador no soporta el tema, cuando activo, entonces aparece mensaje de incompatibilidad. | EP05 |
...
| **EP08** | Gestión y Control | Incluye el manejo de métricas de bankroll, presupuestos, historial de apuestas y control financiero del usuario.  |  |  |
| US18                     | Visualizar métricas de bankroll  | Como apostador avanzado quiero ver cuánto he ganado o perdido para controlar mi presupuesto.                                                   | Scenario 1: Métricas mostradas – Dado que tengo historial, cuando abro resumen, entonces veo gráfico de ganancias.<br><br>Scenario 2: Sin historial – Dado que no tengo apuestas registradas, cuando abro, entonces aparece mensaje vacío. | EP08 |
| US19                     | Ver detalles de partido          | Como usuario quiero abrir ficha de partido para ver datos específicos.                                                                         | Scenario 1: Ficha cargada – Dado que selecciono partido, cuando abro, entonces veo historial, cuotas y alineaciones.<br><br>Scenario 2: Error de carga – Dado que falla la API, cuando abro, entonces aparece mensaje de error. | EP08 |
| US20                     | Exportar historial de apuestas  | Como usuario quiero exportar mi historial en CSV o Excel para analizar mis resultados de manera externa.                                      | Scenario 1: Exportación exitosa – Dado que presiono exportar, cuando confirmo, entonces se descarga el archivo.<br><br>Scenario 2: Falla de exportación – Dado que hay error, cuando intento exportar, entonces se muestra alerta. | EP08 |
| US21                     | Configurar alertas personalizadas | Como usuario quiero configurar alertas por tipo de apuesta para recibir solo notificaciones relevantes.                                      | Scenario 1: Configuración guardada – Dado que activo solo over/under, cuando guardo, entonces recibo solo esas alertas.<br><br>Scenario 2: Error de guardado – Dado que falla el servidor, cuando guardo, entonces aparece mensaje de error. | EP08 |
| US22                     | Establecer presupuesto mensual  | Como apostador responsable quiero definir un límite mensual para controlar mi gasto en apuestas.                                              | Scenario 1: Límite alcanzado – Dado que supero el límite, cuando intento apostar, entonces aparece aviso preventivo.<br><br>Scenario 2: Falla de cálculo – Dado que el sistema no registra apuestas, cuando debería alertar, entonces no aparece el aviso. | EP08 |
| **EP09** | Social & Comunidad | Reúne funciones de interacción social como compartir predicciones, ver opiniones y reaccionar a pronósticos. |  |  |
| US23                     | Compartir predicciones          | Como usuario quiero compartir una predicción en redes sociales para comentar con mis amigos.                                                | Scenario 1: Compartido con éxito – Dado que presiono compartir, cuando confirmo, entonces se genera enlace.<br><br>Scenario 2: Error al compartir – Dado que la red social no responde, cuando confirmo, entonces se muestra error. | EP09 |
| US24                     | Ver opiniones de otros usuarios | Como usuario quiero leer comentarios de la comunidad para contrastar mis decisiones.                                                          | Scenario 1: Comentarios cargados – Dado que abro sección comunidad, cuando carga, entonces veo comentarios.<br><br>Scenario 2: Sin comentarios – Dado que nadie ha comentado, cuando entro, entonces aparece mensaje vacío. | EP09 |
| US25                     | Dejar reacciones a pronósticos | Como usuario quiero reaccionar con emojis a las predicciones para expresar acuerdo o desacuerdo.                                             | Scenario 1: Reacción agregada – Dado que presiono un botón de like, cuando confirmo, entonces aumenta el contador.<br><br>Scenario 2: Falla de reacción – Dado que hay error, cuando presiono, entonces aparece aviso “intenta nuevamente”. | EP09 |
| **EP10** | Experiencia Avanzada  | Engloba funcionalidades para usuarios avanzados como guardar pronósticos, simular combinadas y ajustar nivel de detalle. |  |  |
| US26                     | Guardar pronósticos favoritos  | Como usuario quiero guardar predicciones en una lista para revisarlas después.                                                                 | Scenario 1: Guardado correcto – Dado que presiono favorito, cuando confirmo, entonces aparece en mi lista.<br><br>Scenario 2: Error de guardado – Dado que falla la base de datos, cuando confirmo, entonces aparece mensaje de error. | EP10 |
| US27                     | Configurar nivel de detalle     | Como usuario quiero elegir si ver solo datos básicos o estadísticas avanzadas para personalizar la experiencia.                             | Scenario 1: Nivel aplicado – Dado que selecciono avanzado, cuando confirmo, entonces se muestran métricas extra.<br><br>Scenario 2: Error de configuración – Dado que falla, cuando guardo, entonces no se aplican cambios. | EP10 |
| US28                     | Simular combinadas              | Como apostador quiero simular apuestas combinadas para estimar posibles ganancias antes de apostar.                                           | Scenario 1: Simulación exitosa – Dado que selecciono 3 partidos, cuando confirmo, entonces veo cuota total combinada.<br><br>Scenario 2: Error de cálculo – Dado que hay falla en API, cuando simulo, entonces aparece mensaje de error. | EP10 |
| **EP11** | Integración & Datos  | Epics que manejan la conexión con APIs externas, Google Calendar y reportes de datos incorrectos. |  |  |
| US29                     | Integración con API de casas de apuestas | Como usuario quiero que las cuotas se actualicen automáticamente para tener información en tiempo real.                                     | Scenario 1: Actualización automática – Dado que hay cambio, cuando recargo, entonces se reflejan nuevas cuotas.<br><br>Scenario 2: Falla de API – Dado que la API no responde, cuando cargo, entonces se muestra mensaje de error. | EP11 |
| US30                     | Conexión con Google Calendar   | Como usuario quiero agregar partidos importantes a mi calendario para recibir recordatorios.                                                  | Scenario 1: Evento creado – Dado que presiono añadir, cuando confirmo, entonces aparece en mi calendario.<br><br>Scenario 2: Error de integración – Dado que la conexión falla, cuando confirmo, entonces se muestra error. | EP11 |
| US31                     | Reportar errores en datos      | Como usuario quiero reportar datos incorrectos para que el equipo los corrija.                                                                  | Scenario 1: Reporte enviado – Dado que detecto error, cuando presiono reportar, entonces aparece confirmación.<br><br>Scenario 2: Falla en envío – Dado que hay problema de red, cuando presiono, entonces aparece aviso de fallo. | EP11 |
| **EP12** | Engagement y Gamificación  | Contiene funciones de gamificación como puntos, ranking y desafíos para aumentar el engagement de los usuarios. |  |  |
| US32                     | Recibir puntos por uso         | Como usuario quiero recibir puntos por consultar partidos para motivarme a usar más la app.                                                    | Scenario 1: Puntos sumados – Dado que abro partidos, cuando completo acción, entonces se suman puntos.<br><br>Scenario 2: Error de registro – Dado que falla el servidor, cuando debería sumar, entonces no aparecen puntos. | EP12 |
| US33                     | Ver ranking de usuarios        | Como usuario quiero ver un ranking de aciertos de la comunidad para compararme con otros.                                                     | Scenario 1: Ranking mostrado – Dado que abro la sección, cuando carga, entonces veo lista ordenada.<br><br>Scenario 2: Sin datos – Dado que no hay suficiente información, cuando entro, entonces aparece mensaje vacío. | EP12 |
| US34                     | Desafíos semanales             | Como usuario quiero participar en desafíos de predicciones para competir con otros usuarios.                                                  | Scenario 1: Desafío iniciado – Dado que me inscribo, cuando empieza, entonces recibo lista de partidos.<br><br>Scenario 2: Desafío no disponible – Dado que no hay desafíos activos, cuando entro, entonces aparece mensaje de espera. | EP12 |
| **EP13** | Landing Page | Reúne las secciones públicas del sitio: información general, precios, FAQ y contacto para nuevos usuarios.  |  |  |
| US35                     | Ver información general        | Como visitante quiero ver información de qué es Betalyze para entender el valor de la plataforma.                                             | Scenario 1: Página cargada – Dado que entro a la landing, cuando carga, entonces veo sección “qué es Betalyze”.<br><br>Scenario 2: Error de carga – Dado que el servidor falla, cuando entro, entonces aparece mensaje de error. | EP13 |
| US36                     | Ver precios de suscripción     | Como visitante quiero ver planes y precios de suscripción para evaluar si compro.                                                              | Scenario 1: Precios mostrados – Dado que abro la sección de precios, cuando carga, entonces veo planes detallados.<br><br>Scenario 2: Información no disponible – Dado que hay error, cuando entro, entonces aparece mensaje de “temporalmente no disponible”. | EP13 |
